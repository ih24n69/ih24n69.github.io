  ...
  $(document).ready(function () {
    ...
    function send_form (type) {
     ...
     /* var phone = $("input#phone_" + type).val();
      ...
      var relativeList = ["Azkiyah", "Ihsan"];
     ...
     // console.log(phone);
      ...
      $.ajax({
        type: "POST",
        url: "https://docs.google.com/forms/d/e/1FAIpQLSftRBiJg9PVBPmKmc86yhvrmuh_2URN0Hiqku7HApBPA4owKA/formResponse",
        data: dataObj,
        complete:sent
      });
    }
    ...
    /*CountDown*/
    $('.married_coundown').countdown({until: new Date("Jul 18, 2021 09:00:00")});
